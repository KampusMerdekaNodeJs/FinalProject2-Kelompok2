...
class UserController {
  static register(req, res) {
    const { email, password, username, full_name, age, phone_number, profile_image_url } = req.body;
    User.create({
      email,
      password,
      username,
  ...
  static login(req, res){
    ...
    static async updateUser(req, res) {
      ...
      const { email, username, full_name, age, phone_number, profile_image_url } = req.body;
